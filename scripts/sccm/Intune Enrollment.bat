...
reg query "HKLM\SOFTWARE\YourDomainName\Migration" /v "IntuneEnrolled" >nul 2>&1
if %ERRORLEVEL% EQU 0 (
...
reg add "HKLM\SOFTWARE\YourDomainName\Migration" /v "IntuneEnrolled" /t REG_DWORD /d 1 /f
